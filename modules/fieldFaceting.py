...
def runFieldFaceting(scrapeName, siteName, path, user, passw):
  ...
  browser.get('https://smc.searchspring.net/management/faceting')
  ...
  #navigate to faceting, just in case we aren't there already (we should be)
  browser.get('https://smc.searchspring.net/management/faceting')
